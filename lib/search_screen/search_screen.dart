...
HeaderWithSearchBox    sObj=HeaderWithSearchBox(size: MediaQuery.of(context).size);
                    ...
                    child: Container(
                      child:  DropdownButton(
                        ...
                        items: options.map((obj) {
                          return  DropdownMenuItem(child: Text(obj.toString()), value: obj.toString().toLowerCase(), );
                        }).toList(),
                        onChanged: (value) {
                          setState(() {
...
if(store=='area') {
  Navigator.pushNamed(context, Area.routeName, arguments: store);
}else{
  Navigator.pushNamed(context, Practice.routeName, arguments: store);
