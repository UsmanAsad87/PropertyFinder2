...
class HomeSinglePostScreen extends StatefulWidget {
  final ad;
  const HomeSinglePostScreen({Key? key, required this.ad}) : super(key: key);

  @override
  State<HomeSinglePostScreen> createState() => _HomeSinglePostScreenState();
}

class _HomeSinglePostScreenState extends State<HomeSinglePostScreen> {
  bool loading = true;
