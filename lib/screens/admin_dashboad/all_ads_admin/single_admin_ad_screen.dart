...
import 'package:flutter_application_1/screens/update_prooperty/update_prop_screen.dart';
...
class _SingleAdminPostScreenState extends State<SingleAdminPostScreen> {
  ...
  void doDelete(BuildContext context, String adId) async {
    String msg = await FirestoreMethods().deleteAd(adId);
                  ...
                  return Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ListTile(
                        onTap: () async {
                          Navigator.push(context, MaterialPageRoute(builder: (_)=>UpdatePropertyScreen(ad: widget.ad,)));
                  },
                    //tileColor: Colors.black12,
                    leading: const Icon(Icons.update,
                        color: Colors.white),
                    title: Text('update Ad',
                        ...
                        ListTile(
                          onTap: () async {
                            doDelete(context, widget.ad['adId']);
                          },
                          //tileColor: Colors.black12,
