...
class UserHeaderWithSearchBox extends StatefulWidget {

  // TextEditingController store=TextEditingController();

   UserHeaderWithSearchBox({
    Key? key,
    required this.size,
  }) : super(key: key);
  ...
  @override
  State<UserHeaderWithSearchBox> createState() => _UserHeaderWithSearchBoxState();
}

class _UserHeaderWithSearchBoxState extends State<UserHeaderWithSearchBox> {
